...
/** The ControlSurfces object carries messages for controlling the plane. */
object ControlSurfaces {
  // amount is a value between -1 and 1. the altimeter ensures that any value
  // outside that range is truncated to be within it.
